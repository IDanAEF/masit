...
<div class="modal">
    <?php
        ...
        $masks = json_decode(file_get_contents('../countryes.json'), true);
...
<div class="mobile-menu">
    ...
    <button class="mobile-menu__button text_fz16-1 text_ls005 text_ffHelv button button_green modal-targ" data-modal="message">Calculate the cost</button>
</div>
